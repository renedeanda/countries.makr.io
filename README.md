...
**Country Explorer** is a Next.js app that allows users to learn about and compare countries around the world. It provides detailed information about demographics, geography, and culture, making it a valuable resource for students, travelers, and anyone interested in global affairs.

## Features

- **Country Information** – Explore key statistics and facts about various countries.
- **Comparison Tool** – Compare multiple countries based on different metrics.
- **Responsive Design** – Access the explorer easily across devices.
...
```bash
git clone https://github.com/renedeanda/countries.makr.io.git
cd countries.makr.io
npm install
```
